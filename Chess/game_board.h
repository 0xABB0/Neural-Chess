...
public:
	...
	std::vector<Single_move> get_pawns_moves(bool, int);
	std::vector<Single_move> get_rooks_moves(bool, int);
	std::vector<Single_move> get_knights_moves(bool, int);
	std::vector<Single_move> get_bishops_moves(bool, int);
	std::vector<Single_move> get_queens_moves(bool, int);
	std::vector<Single_move> get_king_moves(bool, int);

	std::vector<Single_move> get_all_moves(bool);
